      ...
      <div className="classic__container">
        ...
        <div className="classic__partners--description">
          <p>
            ...
            center, multi-media technology and an in-house production staff, The
            Georgia Center excels in creating memorable special events.
          </p>
          <p>
            The Peach Tree is renowned for its healthy preperations of decadent
            Southern classics. Winner of two Eat Up Awards and a leader in
            farm-to-table cuisine, The Peach Tree offers casual-chic dining in
