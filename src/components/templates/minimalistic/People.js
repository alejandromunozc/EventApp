...
const People = () => {
  return (
    <section id="people" className="minimalistic__people">
      <div className="container">
        <div className="minimalistic__people--list">
          <h2>People to see</h2>
          <hr />
          <div className="minimalistic__people--speaker">
            <div className="minimalistic__people--speaker-img">
              <img
                className="minimalistic__people--speaker-photo"
                src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80"
                alt=""
              />
            </div>
            <div className="minimalistic__people--speaker-name">
              <div className="minimalistic__people--speaker-title">
                Camila & Arjun
              </div>
              <div className="minimalistic__people--speaker-description">
            ...
            <div className="minimalistic__people--speaker-position">
              <div className="minimalistic__people--position-title">
                Founders
              </div>
              <div className="minimalistic__people--position-company">
                LifeSwap
              </div>
            </div>
          </div>
          <div className="minimalistic__people--speaker">
            ...
            <div className="minimalistic__people--speaker-position">
              <div className="minimalistic__people--position-title">CTO</div>
              <div className="minimalistic__people--position-company">
                Airway
              </div>
            </div>
          ...
          <div className="minimalistic__people--speaker">
            ...
            <div className="minimalistic__people--speaker-name">
              <div className="minimalistic__people--speaker-title">Dj Zeny</div>
              <div className="minimalistic__people--speaker-description">
          ...
          <div className="minimalistic__people--speaker">
            ...
            <div className="minimalistic__people--speaker-position">
              <div className="minimalistic__people--position-title">Grub</div>
              <div className="minimalistic__people--position-company">
                @feedmestileswitch
              </div>
            </div>
